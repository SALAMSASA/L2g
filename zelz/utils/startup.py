...
Zed_Vip = (7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448)
Zed_Dev = (7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 6094238403, 6094238403, 6094238403, 7004732448, 6094238403 , 7004732448, 7004732448, 7004732448)
Zzz_Vip = (7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448, 7004732448)
zchannel = {"@H_8_oj", "@H_8_oi", "@H_8_ol", "@SUPERXFAST", "@cecrr", "@SHS213", "@sssaallhj", "@aalshjs", "@ydoydkgddyo", "@grupmtaem", "@S_1_02", "@fabhsh", "@S_1_02gdd", "@WW06_W", "@WW00_W", "@WW02_W", "@S_1_02g", "@ll0llld", "@E_A_1L", "@L_Q7I", "@A1DIIU", "@L_Q7I", "@wuuwuk", "@H_8_ov", "@H_8_oq", "@e2gg_q", "@chletoon"}
...
async def autovars(): #Code by T.me/H_8_o
...
async def autoname(): #Code by T.me/H_8_o
...
async def mybot(): #Code by T.me/H_8_o
    ...
    try:
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption=f"**⌔ مرحبـاً عـزيـزي** {zel_zal} 🫂\n**⌔ تـم تشغـيل سـورس ليثــون 🧸♥️**\n**⌔ التنصيب الخاص بـك .. بنجـاح ✅**\n**⌔ لـ تصفح قائمـة الاوامـر 🕹**\n**⌔ ارسـل الامـر** `{cmdhr}مساعده`",
                buttons=[[Button.url("𝐋𝐈𝐓𝐇𝐎𝐍 🎡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁", "https://t.me/ll0llld")],[Button.url("الشروحات ²", "https://t.me/chletoon"), Button.url("الشروحات ¹", "https://t.me/A1DIIU")],[Button.url("حلـول الأخطـاء", "https://t.me/WW02_W")],[Button.url("التحـديثـات", "https://t.me/H_8_o")],[Button.url("مطـور السـورس", "https://t.me/N_S_Nbot")]]
            )
    except Exception as e:
        LOGS.error(e)
        return None
    ...
    if BOTLOG:
        ...
        try:
            ...
            if "can't create channels or chat" in str(e):
                ...
                print("- قم بالذهاب الى طريقة الحل عبر الرابط (https://t.me/WW00_W/22)")
