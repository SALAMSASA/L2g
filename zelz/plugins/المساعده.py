...
HELP = f"**🧑🏻‍💻┊مـࢪحبـاً عـزيـزي {mention}**\n**🛂┊في قائمـة المسـاعـده والشـروحـات\n🛃┊من هنـا يمكنـك ايجـاد شـرح لكـل اوامـر السـورس**\n\n[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 ♥️](https://t.me/ll0llld)\n\n"

ZelzalTZ_cmd = (
    "𓆩 𝐋𝐈𝐓𝐇𝐎𝐍 𝗧𝗶𝗺𝗲 **🝢 المنطقة الزمنية** 𓆪\n"
    "**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**\n"
    "**⎉╎قائمـة اوامر تغييـر المنطقـة الزمنيـة لـ ضبط الوقت ع ليثــون حسب توقيت دولتك 🌐:** \n\n"
    "⪼ `.وقت فلسطين` \n"
    "⪼ `.وقت اليمن` \n"
    "⪼ `.وقت العراق` \n"
    "⪼ `.وقت السعودية` \n"
    ...
    "𓆩 [𝐋𝐈𝐓𝐇𝐎𝐍 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/L_Q7I) 𓆪"
)
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("مساعده") and event.query.user_id == zedub.uid:
            ...
            z_username = zme.username if zme.username else "ll0llld"
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر النشــر التلقــائي 🌐](t.me/ll0llld  ) .
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/ll0llld) .
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
**⎉╎قـائمـة اوامـر السـوبـر (النشـر العـام) الخاصـه بـ سـورس ليثــون ♾ :**
...
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
**⪼ مـلاحظــات هـامــه :**
- اوامـر السوبـرات إضـافة جديـدة خاصـه وحصريـه بسـورس ليثــون¹ فقـط ...
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميــع النقــاط 🛂](t.me/ll0llld) .
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/ll0llld) .
**- الامـر :**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البـــوت 🦾🤖](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
                ...
                [
                    ...
                    Button.inline("ليثون", data="zedvr"),
                ],
                [
...
**- الوصـف :**
لـ عـرض تاريـخ بـدء تنصيبك على سـورس ليثــون
...
**- الوصـف :**
لـ عـرض اوامـر الاذاعـه الخاصـه بسـورس ليثــون
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه 🛗](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/ll0llld) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر مكـافح التكــرار 🛡](t.me/ll0llld) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المنــع 🚫](t.me/ll0llld) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافه والتفليـش 👾](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الفــارات 🧬](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الوقتــي 🕰](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الفحـص 🏮](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
**- ملاحظـه :**
هـذا الامـر حصـري فقط وخاص بـ سـورس ليثــون بقية السورسات ماتحمـل دقـة HD ؟!
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎?? 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البحـث والتحميــل 🛰](t.me/ll0llld) .
**- الامـر :**
**⪼** `.فيس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تحميـل الكتب 📕](t.me/ll0llld) .
**- الامـر :**
**⪼** `.كتاب`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر بحـث تيليـجـرام 🛰](t.me/ll0llld) .
**- الامـر :**
**⪼** `.تلي` **+ كلمـة**

**- الوصـف :**
امـر ممطـروق وحصريـاً ع سـورس ليثــون فقـط
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه 🏂](t.me/ll0llld) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التحشيش 🎃](t.me/ll0llld) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الالـعــاب 🎮🎳](t.me/ll0llld) .
**- الامـر :**
**⪼** `.بلاي`
**العــاب الانـلايـن لســورس ليثــون 🕹**
**⪼** `.كت`
**اسئلـة كـت تـويت ⁉️**
**⪼** `.كت`
...
**- الوصـف :**
العـاب سـورس ليثــون ممطـروقـه 🥳💞
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر حمـايــة الخــاص 🛡](t.me/ll0llld) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فــارات حمـايــة الخــاص 🛡](t.me/ll0llld) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المـرفقــات 🖥](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الستـوريـات 🎆🏖](t.me/ll0llld) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/ll0llld) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀??𝗿𝗯𝗼𝘁 - اوامـر السبـام والتكـرار](t.me/ZTho) .
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الادوات 💡](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
...
**لـ معرفـة تاريـخ إنشـاء أي حسـاب على تيـك تـوك :**
https://t.me/ll0llld/292

**لـ معرفـة معلومـات أي حسـاب على انستـاجـرام :**
https://t.me/ll0llld/293
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - ادوات الروابــط 💡](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
...
**- مثـال :**
`.اختصارhttps://github.com/SALAMSASA`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/ll0llld) .
**- الامـر :**
...
**- ملاحظـه :**
سورس ليثون هو اول من كتب فكرة الاشتراك الاجباري واضافها للسورس كـ فكرة جديدة لسورسات تيليثون
الملف كان مدفوع وتم تنزيله مجاني
تـاريـخ كتابـة الملـف - 30 اكتوبر/2022 
 https://t.me/ll0llld/260
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & الـتثبيت ❇️](t.me/ll0llld) .
...
**- انضـم للقنـاة ~ @L_Q7I**
**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن ليثــون**
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميـع النقـاط 💡](t.me/ll0llld) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
